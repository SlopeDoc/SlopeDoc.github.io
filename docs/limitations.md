...
Before using it seriously, be aware of the following limitations:
...
- We also share the general limitations of *literate programming*, hence combining slides from different talks can be difficult if you use scientific code. To alleviate this issue, slope offers ways to import/export data.
